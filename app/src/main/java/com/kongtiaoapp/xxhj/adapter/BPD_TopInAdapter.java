...
/**
 * Created by G_XXHJ on 2018/9/29.  变配电  头部 嵌套
 */

public class BPD_TopInAdapter extends BaseAdapter {
    private Context context;
    private List<BPD_MainInfoBean.ResobjBean.GroupDataBean.EnerParamBean> list;

    public BPD_TopInAdapter(List<BPD_MainInfoBean.ResobjBean.GroupDataBean.EnerParamBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BPD_MainInfoBean.ResobjBean.GroupDataBean.EnerParamBean bean = list.get(position);
