...
public class EfficParaInfoAdapter extends BaseAdapter {
    private List<HVAC_NewProjectDetailBean.ResobjBean.EfficParaInfoBean> list;
    private Context context;

    public EfficParaInfoAdapter(List<HVAC_NewProjectDetailBean.ResobjBean.EfficParaInfoBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HVAC_NewProjectDetailBean.ResobjBean.EfficParaInfoBean bean = list.get(position);
    ...
    public void setList(List<HVAC_NewProjectDetailBean.ResobjBean.EfficParaInfoBean> efficParaInfoList) {
        list=efficParaInfoList;
