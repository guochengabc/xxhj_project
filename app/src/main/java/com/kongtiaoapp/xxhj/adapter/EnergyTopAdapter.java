...
public class EnergyTopAdapter extends BaseAdapter {
    private List<EnergyTopBean.ResobjBean.TopListBean> list;
    private Context context;

    public EnergyTopAdapter(List<EnergyTopBean.ResobjBean.TopListBean> list, Context context) {
        this.list = list;
...
//            convertView =  inflater.inflate(R.layout.whatever, parent, false);
        ...
        EnergyTopBean.ResobjBean.TopListBean bean = list.get(position);
...
/*//此处相当于布局文件中的Android:layout_gravity属性
    ...
    public void setList(List<EnergyTopBean.ResobjBean.TopListBean> stasticArray) {
        list = stasticArray;
