 ...
 * 说明:
 */
public class SelectionPinglunAdapter extends BaseAdapter {
    private List mList;
    private Context mContext;

    public SelectionPinglunAdapter(List mList, Context mContext) {
        this.mList = mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GetSelectionInfo.SelectionInfo.CommentsBean pinglunInfo = (GetSelectionInfo.SelectionInfo.CommentsBean) getItem(position);
        ...
        //判断是不是自己的评论
        if (!TextUtils.isEmpty(pinglunInfo.getToUserId())
                && pinglunInfo.getToUserId() != null
                && !pinglunInfo.getToUserId().isEmpty()
                && !pinglunInfo.getUserId().equals(pinglunInfo.getToUserId())) {
            //二次评论
    ...
    private SpannableStringBuilder setColor(String str, String str1, GetSelectionInfo.SelectionInfo.CommentsBean item) {
