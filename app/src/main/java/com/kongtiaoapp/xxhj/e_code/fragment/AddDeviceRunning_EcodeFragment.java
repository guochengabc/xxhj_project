...
/**
 * Created by xxhj_g on 2017/11/6.  记录数据
 */

public class AddDeviceRunning_EcodeFragment extends BaseFragment<AddDeviceRunningPresenter, AddDeviceRunningView> implements AddDeviceRunningView,
