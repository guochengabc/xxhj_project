...
import com.kongtiaoapp.xxhj.e_code.adapter.NameplateInfoAdapter;
...
public class NameplateInformationFragment extends BaseFragment<AddDeviceRunningPresenter, AddDeviceRunningView> implements AddDeviceRunningView,
    ...
    @BindView(R.id.line_namePlate)
    LinearLayout line_namePlate;
    private String type = "";
    private NameplateInfoAdapter adapter;
    ...
    public void initData() {
        super.initData();
        line_namePlate.setVisibility(View.GONE);
    ...
    private void getData() {
        presenter.getNameplate(mActivity, deviceId);
    }
    ...
    public void setList(Object data) {
        ...
        adapter = new NameplateInfoAdapter(mList, mActivity);
    ...
    public void setData(DeviceNameE_CodeBean bean) {
