 ...
 */
public class EnergymeteringFragment extends BaseFragment<HeatMeteringPresenter, HeatMeteringView> implements HeatMeteringView {
    @BindView(R.id.rl_energyTop)
    RelativeLayout rl_energyTop;
    ...
    protected View initView() {
        return View.inflate(mActivity, R.layout.activity_heat_metering, null);
    }

    @Override
    public void initData() {
        super.initData();
        rl_energyTop.setVisibility(View.GONE);
    ...
    @Override
    public HeatMeteringPresenter getPresenter() {
    ...
    public void getTopList(Object data) {
        ...
        if (groupData != null) {
            EnergyTopAdapter adapter = new EnergyTopAdapter(groupData, mActivity);
