...
import com.kongtiaoapp.xxhj.mvp.presenter.MyFavoriteMomentsPresneter;
 ...
 */
public class MyFavoriteMomentsFragment extends BaseFragment<MyFavoriteMomentsPresneter,MyFavoriteMomentsView> implements  MyFavoriteMomentsView, EnergyListAdapter.OperationListener {
    ...
    public MyFavoriteMomentsFragment() {
    }
    ...
    @Override
    public MyFavoriteMomentsPresneter getPresenter() {
        return new MyFavoriteMomentsPresneter();
    }
    @Override
