...
public class ParamPaintWaterActivity extends BaseActivity<ParamPaintP, ParamPaintV> implements ParamPaintV, RadioGroup.OnCheckedChangeListener {
    ...
    protected int initContentView() {
        return R.layout.activity_param_paint_water;
    }
