...
import com.kongtiaoapp.xxhj.mvp.presenter.Register_GroupPresenter;
...
/**
 *
 * 发送验证码的倒计时没有走  后期要是有集团的需要加上
 * */
public class Register_Group_Fragment extends BaseFragment<Register_GroupPresenter, Register_GroupView> implements Register_GroupView {
    @BindView(R.id.rg_check_agree)
    CheckBox rg_check_agree;
    @BindView(R.id.rg_txt_company_name)
    TextView rg_txt_company_name;//集团名

    @BindView(R.id.rg_txt_found)
    TextView rg_txt_found;
    @BindView(R.id.rg_txt_instruction)//说明
            TextView rg_txt_instruction;
    @BindView(R.id.rg_pl_company_name)//请输入集团名称
  ...
  /*  Handler mHandler = new Handler() {
    ...
    @Override
    public Register_GroupPresenter getPresenter() {
        return new Register_GroupPresenter();
    }
    ...
    public void initData() {
        super.initData();
        rg_txt_company_name.setText(getResources().getString(R.string.group_name));
        rg_pl_company_name.setHint(getResources().getString(R.string.pl_group_number));
        rg_txt_instruction.setText(getString(R.string.group_instruction));
        rg_txt_found.setText(getString(R.string.found_group_number));
        ...
        switch (txt_found.getId()) {
            case R.id.rg_txt_found:
                ...
                if (!checkNetworked()) {
                    ...
                    ToastUtils.showToast(mActivity, getResources().getString(R.string.pl_group_number));
                    return;
