...
import com.kongtiaoapp.xxhj.mvp.module.MyPublishMomentsModule;
 ...
 */
public class MyPublishMomentslpl implements MyPublishMomentsModule {
    @Override
    public void getDataForservices(Activity activity, Object data, ResponseXXHJListener listener) {
        ...
        params.put(HttpMethod.KEY, ParamJson.map2Json(HttpMethod.GETMYESMESSAGELIST, map));
