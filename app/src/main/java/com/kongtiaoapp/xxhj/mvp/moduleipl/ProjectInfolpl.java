...
import com.kongtiaoapp.xxhj.mvp.module.ProjectInfoModule;
 ...
 */
public class ProjectInfolpl implements ProjectInfoModule {
    @Override
    ...
    public void delete(Activity activity, Object data, ResponseXXHJListener listener) {
        ...
        Map<String, String> params = new HashMap<String, String>();
        params.put(HttpMethod.KEY, ParamJson.map2Json(HttpMethod.DELETEPROJECTINFO, map));
