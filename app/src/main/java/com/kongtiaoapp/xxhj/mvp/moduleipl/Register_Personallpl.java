...
import com.kongtiaoapp.xxhj.mvp.module.Register_PersonalModule;
 ...
 */
public class Register_Personallpl implements Register_PersonalModule {
    @Override
    public void getDataForservices(Activity activity, Object data, ResponseXXHJListener listener) {
        ...
        map.put("inviteCode", list.get(2));
        map.put("userName", list.get(3));
        map.put("verifyCode", list.get(4));
        Map<String, String> params = new HashMap<String, String>();
        params.put(HttpMethod.KEY, ParamJson.map2Json(HttpMethod.SIGNUPPERSON, map));
