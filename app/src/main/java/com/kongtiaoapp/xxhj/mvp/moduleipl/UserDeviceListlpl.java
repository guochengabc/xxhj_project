...
import com.kongtiaoapp.xxhj.mvp.module.UserDeviceListModule;
 ...
 */
public class UserDeviceListlpl implements UserDeviceListModule {
    @Override
    public void getDataForservices(Activity activity, Object data, ResponseXXHJListener listener) {
        ...
        params.put(HttpMethod.KEY, ParamJson.map2Json(HttpMethod.GETDEVICELIST, map));
