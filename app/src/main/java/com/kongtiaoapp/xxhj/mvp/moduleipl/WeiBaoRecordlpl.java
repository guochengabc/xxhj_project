...
import com.kongtiaoapp.xxhj.mvp.module.WeiBaoRecordModule;
 ...
 */
public class WeiBaoRecordlpl implements WeiBaoRecordModule {
    @Override
    public void getDataForservices(Activity activity, Object data, ResponseXXHJListener listener) {
        ...
        new GetTask<GetMTRecordList>(activity, GetMTRecordList.class, ConstantValue.HTTP_URLS + Encode_params.YesToken_Encodeparms(params), true, listener).execute();
    }
