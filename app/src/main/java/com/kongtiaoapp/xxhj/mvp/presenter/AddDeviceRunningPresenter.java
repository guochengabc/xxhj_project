...
import com.kongtiaoapp.xxhj.mvp.moduleipl.AddDeviceRunninglpl;
 ...
 */
public class AddDeviceRunningPresenter extends BasePresenterLpl<AddDeviceRunningView, AddDeviceRunninglpl> {
    @Override
    protected AddDeviceRunninglpl getModel() {
        return new AddDeviceRunninglpl();
    }
