...
import com.kongtiaoapp.xxhj.mvp.moduleipl.SeletionDetaillpl;
 ...
 */
public class SelectionDetailPresenter extends BasePresenterLpl<SelectionDetailView, SeletionDetaillpl> {
    @Override
    protected SeletionDetaillpl getModel() {
        return new SeletionDetaillpl();
    }
