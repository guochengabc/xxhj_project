...
import com.kongtiaoapp.xxhj.prefessionalknowledge.adapter.MyEnergyShowAdapter;
import com.kongtiaoapp.xxhj.afinal.ConstantValue;
import com.kongtiaoapp.xxhj.bean.EnergyShow;
import com.kongtiaoapp.xxhj.mvp.base.BaseActivity;
import com.kongtiaoapp.xxhj.mvp.presenter.EnergyShowFormePresenter;
 ...
 */
public class EnergyShowFormeActivity extends BaseActivity<EnergyShowFormePresenter, EnergyShowFormeView> implements EnergyShowFormeView {
    @BindView(R.id.tv_my_show)//右上角的节能我的节能展会
    TextView tvMyShow;
    @BindView(R.id.listView)//节能展会列表
    ListView listView;
    @BindView(R.id.springView)
    SpringView springView;
    @BindView(R.id.tv_title)//节能展会标题
    TextView tvTitle;
    ...
    private MyEnergyShowAdapter adapter;
    ...
    protected void initData() {
        adapter = new MyEnergyShowAdapter(mContext, mList);
        listView.setAdapter(adapter);
        getDataForService();
    }

    @Override
    protected EnergyShowFormePresenter getPresenter() {
        return new EnergyShowFormePresenter();
    }
    ...
    public void setList(Object response) {
        EnergyShow data = (EnergyShow) response;
        if (isRefresh) {
            mList.clear();
        }
