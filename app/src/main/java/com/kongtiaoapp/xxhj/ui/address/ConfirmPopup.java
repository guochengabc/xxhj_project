...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    /**
     * Sets top include_material_consumtion color.
     *
     * @param topLineColor the top include_material_consumtion color
     */
    ...
    /**
     * Sets top include_material_consumtion visible.
     *
     * @param topLineVisible the top include_material_consumtion visible
     */
