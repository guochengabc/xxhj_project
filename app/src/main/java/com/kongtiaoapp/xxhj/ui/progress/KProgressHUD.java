...
package com.kongtiaoapp.xxhj.ui.progress;
...
public class KProgressHUD {
   ...
   */
    ...
    public KProgressHUD setStyle(Style style) {
        View view = null;
        switch (style) {
            case SPIN_INDETERMINATE://旋转的progress
                view = new SpinView(mContext);
                break;
            case PIE_DETERMINATE://饼状的进度条
                view = new PieView(mContext);
                break;
            case ANNULAR_DETERMINATE://环形进度条
                view = new AnnularView(mContext);
                break;
            case BAR_DETERMINATE:
                view = new BarView(mContext);//条状进度条
                break;
