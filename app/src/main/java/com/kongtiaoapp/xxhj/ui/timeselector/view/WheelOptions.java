package com.kongtiaoapp.xxhj.ui.timeselector.view;

import android.view.View;


import com.kongtiaoapp.xxhj.R;
import com.kongtiaoapp.xxhj.ui.timeselector.adapter.ArrayWheelAdapter;
import com.kongtiaoapp.xxhj.ui.timeselector.lib.WheelView;
	...
	public void setPicker(ArrayList<T> options1Items,
		...
		if (mOptions3Items != null)
			wv_option3.setAdapter(new ArrayWheelAdapter(mOptions3Items.get(0)
					.get(0)));// 设置显示数据
		wv_option3.setCurrentItem(wv_option3.getCurrentItem());// 初始化时显示的数�?
        ...
        wheelListener_option1 = new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				int opt2Select = 0;
				if (mOptions2Items != null) {
                    opt2Select = wv_option2.getCurrentItem();//上一个opt2的�?�中位置
					//新opt2的位置，判断如果旧位置没有超过数据范围，则沿用旧位置，否则�?�中�?后一�?
        ...
        wheelListener_option2 = new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				if (mOptions3Items != null) {
					...
					int opt3 = wv_option3.getCurrentItem();//上一个opt3的�?�中位置
                    //新opt3的位置，判断如果旧位置没有超过数据范围，则沿用旧位置，否则�?�中�?后一�?
