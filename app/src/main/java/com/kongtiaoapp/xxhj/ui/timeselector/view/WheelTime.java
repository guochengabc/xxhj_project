...
import com.kongtiaoapp.xxhj.ui.timeselector.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_year.setAdapter(new NumericWheelAdapter(startYear, endYear));// 设置"�?"的显示数�?
        wv_year.setLabel(context.getString(R.string.pickerview_year));// 添加文字
        wv_year.setCurrentItem(year - startYear);// 初始化时显示的数�?
        // �?
