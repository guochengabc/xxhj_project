...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFFFFFFFF;    //指示线颜色
    ...
    private int indicatorHeight = 2;    //指示线宽度
    private int underlineHeight = 2;
    private int dividerPadding = 12;
    private int tabPadding = 12;
    private int dividerWidth = 8;

    private int tabTextSize = 18;    //标题文字大小
    ...
    private int tabBackgroundResId = 0;        //标题按下的状态选择器
    ...
    public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(0, tabTextColor);//系统自己是1
...
//				tab.setTextColor(i==0?getResources().getColor(R.color.slidingtab_indicatorcolor):tabTextColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw indicator include_material_consumtion

        rectPaint.setColor(indicatorColor);

        // default: include_material_consumtion below current tab
