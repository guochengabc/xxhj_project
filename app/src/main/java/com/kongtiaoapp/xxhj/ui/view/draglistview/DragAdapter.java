 ...
 * to {@link DragListView#setAdapter(ListAdapter)} and, since
 * this class implements the {@link DragListView.DragSortListener}
 * interface, it is automatically set as the DragSortListener for
 * the DragSortListView instance.
 */
public abstract class DragAdapter extends CursorAdapter implements DragListView.DragSortListener {
    ...
    public DragAdapter(Context context, Cursor c, boolean autoRequery) {
        super(context, c, autoRequery);
    }

    public DragAdapter(Context context, Cursor c, int flags) {
