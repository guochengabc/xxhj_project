...
public class DragController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    public DragController(DragListView dslv) {
        this(dslv, 0, ON_DOWN, FLING_REMOVE);
    }

    public DragController(DragListView dslv, int dragHandleId, int dragInitMode, int removeMode) {
        this(dslv, dragHandleId, dragInitMode, removeMode, 0);
    }

    public DragController(DragListView dslv, int dragHandleId, int dragInitMode, int removeMode, int clickRemoveId) {
        this(dslv, dragHandleId, dragInitMode, removeMode, clickRemoveId, 0);
    }

    public DragController(DragListView dslv, int dragHandleId, int dragInitMode,
     ...
     * based on DragController settings (such as remove mode).
