...
package com.kongtiaoapp.xxhj.ui.view.draglistview;
...
public class DragListView extends ListView {
	...
	public DragListView(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			mTrackDragSort = a.getBoolean(
					R.styleable.DragListView_track_drag_sort, false);
			...
			mDragEnabled = a.getBoolean(
					R.styleable.DragListView_drag_enabled, mDragEnabled);
			...
			float frac = a.getFloat(
					R.styleable.DragListView_drag_scroll_start,
			...
			if (useDefault) {
				...
				int removeMode = a.getInt(
						R.styleable.DragListView_remove_mode,
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView != null) {
				...
				if (child instanceof Checkable) {
					v = new DragItemViewCheck(getContext());
				} else {
	 ...
	 *            this height.
	 *
	 * @return Shuffle include_material_consumtion between position-1 and position (for the given view
	 *         of the list; that is, for when top of item at position has
	 *         y-coord of given `top`). If floating View (treated as horizontal
	 *         include_material_consumtion) is dropped immediately above this include_material_consumtion, it lands in
	 *         position-1. If dropped immediately below this include_material_consumtion, it lands in
	 *         position.
	 */
