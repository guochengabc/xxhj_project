...
public abstract class ClassUtils {
	...
	/**
	 * Override the thread context ClassLoader with the environment's MainBean ClassLoader
	 * if necessary, i.e. if the MainBean ClassLoader is not equivalent to the thread
