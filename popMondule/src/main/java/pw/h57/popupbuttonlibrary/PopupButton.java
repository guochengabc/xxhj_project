...
import pw.h57.popupbuttonlibrary.adapter.PopupDoubleAdapter;
...
public class PopupButton extends Button implements PopupWindow.OnDismissListener {
        ...
        this.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (popupWindow == null) {
                    ...
                    System.out.println("=========一屏高度====screenWidth===" + screenHeight + "=========" + LinearLayout.LayoutParams.WRAP_CONTENT);
    ...
    public void setOneClickData(Activity activity, final List<PopButtonBean.PopInnerBean> listLeft) {
        ...
        Button btn_pop = ((Button) view.findViewById(R.id.btn_pop));
        final PopupAdapter adapterOne = new PopupAdapter(activity, R.layout.popup_item, listLeft, R.drawable.normal, R.drawable.press);
    ...
    public void setDoubleClickData(Activity activity, List<PopButtonBean.PopInnerBean> listLeft, final List<List<PopButtonBean.PopInnerBean>> listRight) {
        ...
        final PopupDoubleAdapter pAdapter = new PopupDoubleAdapter(activity, R.layout.popup_double_item, listLeft, R.drawable.normal, R.drawable.press2);
        final PopupDoubleAdapter cAdapter = new PopupDoubleAdapter(activity, R.layout.popup_double_item, cValues, R.drawable.normal, R.drawable.press);
